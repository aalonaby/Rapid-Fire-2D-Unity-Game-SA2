...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void HandleObstacles()
    {
        ...
        {
            var _obstacleCollision = _obstacleCollisions[index];

            if (_obstacleCollision.collider.gameObject == gameObject)
            {
                continue;
            }
            ...
            {
                _obstacleAvoidanceTargetDirection = _obstacleCollision.normal;
